...
export type DrawReason = "stalemate" | "insufficient" | "repetition" | "fiftyMove" | "other";
...
export function getStatus(fen: string): GameStatus {
	...
	return { kind: "InProgress", turn: chess.turn() as Color, inCheck: chess.inCheck() };
}
...
export function chooseBotMoveWithDifficulty(
	...
	return { from: chosen.from as Square, to: chosen.to as Square, promotion: (chosen as any).promotion ?? "q" };
}
